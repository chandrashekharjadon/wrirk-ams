...
<div class="container-fluid px-4 py-5">
    ...
    <div class="text-start mb-4">
        <h2 class="fw-bold page-title">
            <i class="bi bi-pencil-square me-2"></i> Edit Work From Home Record
        </h2>
        <p class="text-light small opacity-75">
            Modify the details of an existing WFH entry.
        </p>
    </div>
    ...
    <div class="card dashboard-card p-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h5 class="text-light fw-semibold mb-0">Update WFH Details</h5>
        ...
        {{-- ✅ Form --}}
        <form action="{{ route('admin.wfhs.update', $wfh->id) }}" method="POST" class="needs-validation" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <select name="user_id" class="form-select glass-input select-dark" required>
                        ...
                        @foreach($users as $user)
                            <option value="{{ $user->id }}" {{ old('user_id', $wfh->user_id) == $user->id ? 'selected' : '' }}>
                                {{ $user->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <input 
                            ...
                            name="percent" 
                            class="form-control glass-input text-white" 
                            value="{{ old('percent', $wfh->percent) }}" 
                            min="0" max="100" 
                            required>
                        <span class="input-group-text bg-transparent text-light border-light">%</span>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <input 
                        ...
                        name="check_in" 
                        class="form-control glass-input text-white" 
                        value="{{ old('check_in', $wfh->check_in) }}" 
                        required>
                ...
                <div class="col-md-6">
                    ...
                    <input 
                        ...
                        name="check_out" 
                        class="form-control glass-input text-white" 
                        value="{{ old('check_out', $wfh->check_out) }}" 
                        required>
                ...
                <div class="col-md-12">
                    ...
                    <textarea 
                        ...
                        class="form-control glass-input text-white" 
                        rows="3" 
                        placeholder="Enter remark (optional)">{{ old('remark', $wfh->remark) }}</textarea>
                </div>
            </div>
