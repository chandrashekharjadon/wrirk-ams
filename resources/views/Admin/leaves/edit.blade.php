...
<div class="container-fluid px-4 py-5">
    ...
    <div class="text-start mb-4">
        ...
        <p class="text-light small opacity-75">
            Update the details of an existing leave entry.
        </p>
    </div>
    ...
    <div class="card dashboard-card p-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h5 class="text-light fw-semibold mb-0">Update Leave</h5>
        ...
        {{-- ✅ Edit Form --}}
        <form action="{{ route('admin.leaves.update', $leave->id) }}" method="POST" class="needs-validation" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <select name="user_id" class="form-select glass-input select-dark" required>
                        ...
                        @foreach($users as $user)
                            <option value="{{ $user->id }}" {{ old('user_id', $leave->user_id) == $user->id ? 'selected' : '' }}>
                                {{ $user->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" name="date" class="form-control glass-input text-white"
                          value="{{ old('date', \Carbon\Carbon::parse($leave->date)->format('Y-m-d')) }}" required>
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="reason" class="form-control glass-input text-white" rows="3"
                              placeholder="Enter reason (optional)">{{ old('reason', $leave->reason) }}</textarea>
                </div>
            </div>
