...
<div class="container-fluid px-4 py-5">
    ...
    <div class="text-start mb-4">
        ...
        <p class="text-light small opacity-75">
            Modify details of an existing holiday.
        </p>
    </div>
    ...
    <div class="card dashboard-card p-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h5 class="text-light fw-semibold mb-0">Update Holiday</h5>
        ...
        {{-- ✅ Edit Form --}}
        <form action="{{ route('admin.holidays.update', $holiday->id) }}" method="POST" class="needs-validation" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <select 
                        ...
                        @foreach($types as $type)
                            <option value="{{ $type }}" {{ old('type', $holiday->type) == $type ? 'selected' : '' }}>
                                {{ ucfirst($type) }}
                            </option>
                        @endforeach
                    </select>
                ...
                <!-- Restricted Users -->
                @php
                    $selectedUsers = old('users', $holiday->users->pluck('id')->toArray());
                @endphp
                <div class="col-md-6" id="restrictedUsers" style="display: none;">
                    ...
                    <!-- ✅ FIXED: use container instead of single hidden input -->
                ...
                <div class="col-md-12">
                    ...
                    <textarea 
                        ...
                        class="form-control glass-input text-white" 
                        rows="3" 
                        placeholder="Optional">{{ old('description', $holiday->description) }}</textarea>
                </div>
            </div>
...
(() => {
    ...
    let selected = @json($selectedUsers);
    ...
    function renderTags() {
        ...
        // ✅ FIX: rebuild hidden inputs for each user
    ...
    renderTags(); // render preselected users
})();
</script>
