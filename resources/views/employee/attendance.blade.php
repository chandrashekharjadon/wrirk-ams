    ...
    <main class="flex-fill">
        <div class="container-fluid px-4 py-5">
            ...
            <div class="text-start mb-4">
                <h2 class="fw-bold page-title">My Attendance Report 📆</h2>
                <p class="text-light small opacity-75">See your weekly and monthly attendance breakdown.</p>
            </div>

            <!-- Filter Form -->
            <div class="card dashboard-card p-4 mb-4 no-hover">
                <form method="GET" action="{{ route('employee.attendance') }}" class="row g-3 align-items-end">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-4 d-flex align-items-end">
                        <button type="submit" class="btn btn-premium me-2"><i
                                class="bi bi-funnel me-1"></i>Search</button>
                        <a href="{{ route('employee.attendance') }}" class="btn btn-secondary reset-btn">
